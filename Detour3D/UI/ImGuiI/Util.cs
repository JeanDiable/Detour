...
namespace Detour3D.UI.ImGuiI
{
    static class Util
    {
        ...
        public static void CreateProgram(string Name, out int Program)
        {
            ...
            Console.WriteLine($"IMGUI create GLP:{Program}");
        ...
        public static void CreateBuffer(string Name, out int Buffer)
        {
            ...
            Console.WriteLine($"imgui create {Name} buffer {Buffer}");
        ...
        public static void CreateVertexArray(string Name, out int VAO)
        {
            ...
            Console.WriteLine($"imgui create vertex array object {VAO}");
