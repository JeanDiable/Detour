namespace ThreeCs.Extras
{
  ...
  //          var indices = Array.CreateInstance(typeArray, gridX * gridY * 6) as IList;
            ...
            Attributes.Index = new BufferAttribute<uint>(indices, 1);
            Attributes.Position=new BufferAttribute<float>(vertices, 3);
            Attributes.Normal = new BufferAttribute<float>(normals, 3);
            Attributes.UV = new BufferAttribute<float>(uvs, 2);
        }
    }
}
