    ...
    public class UniformsLib : Dictionary<string, Uniforms>
    {
        ...
        private Uniforms MakeLights()
        {
            return new Uniforms
            {
                ...
                { "pointLightDistance",         new Uniform() { {"type", "fv1"},  {"value", new Hashtable()}}},
                ...
                { "spotLightDistance",          new Uniform() { {"type", "fv1"},  {"value", new Hashtable()}}},
                { "spotLightAngleCos",          new Uniform() { {"type", "fv1"},  {"value", new Hashtable()}}},
                { "spotLightExponent",          new Uniform() { {"type", "fv1"},  {"value", new Hashtable()}}},
            };
        }
