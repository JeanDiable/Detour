...
void main()
{
    ...
    if (assignColor.w > 0) ourColor = assignColor;
        ...
        if (aColor < step1) ourColor = vec4(0, aColor / step1, 1, 1); 
        else if (aColor < step1 + step2) ourColor = vec4(0, 1, (step2 - aColor) / step2, 1);
        else if (aColor < step1 + step2 + step3) ourColor = vec4(aColor / step3, 1, 0, 1);
        else ourColor = vec4(1, (step4 - aColor) / step4, 0, 1);
    }
